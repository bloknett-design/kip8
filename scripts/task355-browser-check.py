...
def setup_ctx(browser, viewport, token, theme=None, role='Админ'):
    ...
    def block_external(route):
        route.fulfill(status=404, content_type='text/plain', body='not found (browser-check t355 (kip8))')
...
with sync_playwright() as p:
    ...
    ctx, page, js_errors = setup_ctx(browser, {'width':1280,'height':800}, 'bc-t355k8-a', theme='dark')
    seed_pcal_js(page)
    page.reload()
    ...
    ctx2, page2, js_errors2 = setup_ctx(browser, {'width':1280,'height':800}, 'bc-t355k8-b', theme='light')
    seed_pcal_js(page2)
    page2.reload()
    ...
    ctx3, page3, js_errors3 = setup_ctx(browser, {'width':390,'height':760}, 'bc-t355k8-c', theme='dark')
    seed_pcal_js(page3)
    page3.reload()
