...
def attach(page, ctx, theme, tag, viewer=False):
    ...
    ctx.add_init_script(
        ...
        "localStorage.setItem('kip8_session_token','bc-t388-%s');" % tag +
...
with sync_playwright() as p:
    ...
    page.screenshot(path='/tmp/t388k8-proof-legend-short.png', full_page=False)
    ...
    page.screenshot(path='/tmp/t388k8-proof-totals-shift.png', full_page=False)
    ...
    if ev1['btn'] and ev1['visible']:
        ...
        page.screenshot(path='/tmp/t388k8-proof-bar-exp-top.png', full_page=False)
        page.click('#wsEventsPanel .ws-bar-exp')
        page.wait_for_timeout(500)
    ...
    page.screenshot(path='/tmp/t388k8-proof-workers-general.png', full_page=False)
    ...
    page.screenshot(path='/tmp/t388k8-proof-workers-tab.png', full_page=False)
    # возврат на «Общую»
    ...
    check('K4: ВСЕ краткие обозначения на странице скрыты CSS',
          page2.evaluate("(function(){ var all = document.querySelectorAll('#wsLgPageBody .ws-lg-short'); " +
                         ...
                         "return true; })()"))
    page2.screenshot(path='/tmp/t388k8-proof-mobile-legend.png', full_page=False)
    page2.evaluate("navigateTo('work-schedule')")
    ...
    page2.screenshot(path='/tmp/t388k8-proof-mobile-workers.png', full_page=False)
