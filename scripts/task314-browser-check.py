...
with sync_playwright() as p:
    ...
    page.evaluate("localStorage.setItem('kip8_session_token','browser-check-t314-k8')")
    ...
    page2.evaluate("localStorage.setItem('kip8_session_token','browser-check-t314-k8-offline')")
    page2.reload()
    ...
    page3.evaluate("localStorage.setItem('kip8_session_token','browser-check-t314-k8-viewer')")
    ...
    page4.evaluate("localStorage.setItem('kip8_session_token','browser-check-t314-k8-mobile')")
