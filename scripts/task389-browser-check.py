...
def attach(page, ctx, theme, tag, viewer=False):
    ...
    ctx.add_init_script(
        ...
        "localStorage.setItem('kip8_session_token','bc-t389-%s');" % tag +
...
with sync_playwright() as p:
    ...
    page.screenshot(path='/tmp/t389k8-proof-events-dark.png', full_page=False)
    ...
    check('D4: фон окна прежний (#0e1621)', evp['panelBg'] == 'rgb(14, 22, 33)',
          evp['panelBg'])
    page.screenshot(path='/tmp/t389k8-proof-events-prevmonth.png', full_page=False)
    ...
    page.screenshot(path='/tmp/t389k8-proof-workers-general.png', full_page=False)
    ...
    page.screenshot(path='/tmp/t389k8-proof-add-sheet.png', full_page=False)
    ...
    page3.screenshot(path='/tmp/t389k8-proof-events-light.png', full_page=False)
    ...
    page2.screenshot(path='/tmp/t389k8-proof-mobile-workers.png', full_page=False)
