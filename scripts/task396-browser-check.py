...
def attach(page, ctx, theme, tag, perms, role='Админ'):
    ...
    ctx.add_init_script(
        ...
        "localStorage.setItem('kip8_session_token','bc-t396k8-%s');" % tag +
...
with sync_playwright() as p:
    ...
    page.screenshot(path='task396k8-proof-workers-dark.png', full_page=False)
    ...
    page.screenshot(path='task396k8-proof-workers-view.png', full_page=False)
    ctx.close()
    ...
    page.screenshot(path='task396k8-proof-mobile-light.png', full_page=False)
    ctx.close()
