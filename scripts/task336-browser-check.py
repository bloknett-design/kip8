...
def setup_ctx(browser, viewport, token, theme=None, role='Админ', dsf=1):
    ...
    def block_external(route):
        route.fulfill(status=404, content_type='text/plain', body='not found (browser-check t336 (kip8))')
...
with sync_playwright() as p:
    ...
    ctx, page, js_errors = setup_ctx(browser, {'width':375,'height':720}, 'bcheck-k8-t336-a', theme='dark', dsf=3)
    ...
    ctx, page, js_errors = setup_ctx(browser, {'width':1440,'height':900}, 'bcheck-k8-t336-b', theme='dark')
    page.evaluate("navigateTo('kip-ios')")
