...
with sync_playwright() as p:
    ...
    page.evaluate("localStorage.setItem('kip8_session_token','browser-check-t308-kip8')")
    page.reload()
    ...
    page2.evaluate("localStorage.setItem('kip8_session_token','browser-check-t308-kip8-ro')")
    page2.reload()
