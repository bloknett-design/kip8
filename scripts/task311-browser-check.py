...
with sync_playwright() as p:
    ...
    page.evaluate("localStorage.setItem('kip8_session_token','browser-check-t311-k8')")
    page.reload()
    page.wait_for_timeout(2500)
    ...
    pagem.evaluate("localStorage.setItem('kip8_session_token','browser-check-t311-k8-m')")
    pagem.reload()
    ...
    page2.evaluate("localStorage.setItem('kip8_session_token','browser-check-t311-k8-ro')")
    page2.reload()
