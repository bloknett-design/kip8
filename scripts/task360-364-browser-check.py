...
def setup_ctx(browser, viewport, token, theme=None, saved_view=None):
    ...
    def block_external(route):
        route.fulfill(status=404, content_type='text/plain', body='not found (browser-check t364-k8)')
...
with sync_playwright() as p:
    ...
    page.screenshot(path='scripts/task360-364-proof-grid.png')
    ...
    page.screenshot(path='scripts/task360-364-proof-print.png', full_page=True)
