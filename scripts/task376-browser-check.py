...
def setup_ctx(browser, viewport, token, theme='dark'):
    ...
    def block_external(route):
        route.fulfill(status=404, content_type='text/plain', body='not found (browser-check k8-376)')
...
with sync_playwright() as p:
    ...
    ctx, page, js_errors = setup_ctx(browser, {'width': 1280, 'height': 800}, 'bc-k8-376-a')
    ...
    page.screenshot(path='scripts/task376-proof-flow-kip8.png', full_page=True)
    ctx.close()
