...
// Task 253 (перенос Tasks 249-252 из kip8test@4a6da97): батч из 4 задач —
// крошки «Графика работы», шахматка без легенды до низа окна + коды статусов,
// попап ввода статусов с пакетным сохранением. Одна партия = один инкремент.
const CACHE_VERSION = 'kipia-v402';
